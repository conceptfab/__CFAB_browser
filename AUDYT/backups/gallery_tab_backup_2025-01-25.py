...
class GalleryTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        # Prawa połowa - suwak rozmiaru thumbnail
    ...
    def _create_thumbnail_grid(self):
        ...
        # Jeśli brak asset-ów, pokaż komunikat
        if not self.assets:
        ...
        # Oblicz ilość kolumn na podstawie rozmiaru okna i thumbnail
        columns = self._calculate_columns()

        # Pobierz aktualny rozmiar z slidera
        ...
        print(f"Znaleziono {len(self.assets)} asset-ów")
    ...
    def _calculate_columns(self) -> int:
        """Oblicza liczbę kolumn na podstawie szerokości okna i rozmiaru thumbnail"""
        available_width = self.scroll_area.width() - 40  # Odjęcie marginesów
        thumbnail_size = self.thumbnail_size_slider.value()
        tile_width = thumbnail_size + 20  # dodać padding

        # Oblicz liczbę kolumn z uwzględnieniem spacing
        columns = max(
            1,
            (available_width + self.tile_spacing) // (tile_width + self.tile_spacing),
        )
    ...
    def _create_asset_tile(
        ...
        """Tworzy pojedynczy kafelek asset"""
    ...
    def _on_slider_changed(self, value):
        ...
        # Aktualizuj rozmiary wszystkich kafelków
        self._update_tile_sizes(value)

        # Przelicz kolumny i odśwież siatkę
        self._create_thumbnail_grid()
    ...
    def resizeEvent(self, event):
        ...
        # Odśwież siatkę gdy okno zostanie zmienione
