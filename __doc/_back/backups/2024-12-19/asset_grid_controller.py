...
class AssetGridController(QObject):
    ...
    def rebuild_asset_grid(self, assets: list, preserve_filter: bool = True):
        ...
        with measure_operation(
            ...
            if preserve_filter and self.active_star_filter > 0:
                # Filtruj assety zgodnie z aktywnym filtrem
                filtered_assets = self._apply_star_filter(
    ...
    def _apply_star_filter(self, assets: list, min_stars: int) -> list:
        ...
        for asset_data in assets:
            ...
            try:
                asset_stars_int = int(asset_stars) if asset_stars is not None else 0
