...
/// Zwraca informacje o kompilacji modułu Rust
#[pyfunction]
pub fn get_build_info() -> HashMap<String, String> {
    let mut info = HashMap::new();
    
    // Numer modułu (1)
    info.insert("module_number".to_string(), "1".to_string());
...
pub fn get_module_info() -> String {
    format!(
        "Rust Scanner Module (module: {}, build: {}, target: {})",
        1,
...
pub fn get_log_prefix() -> String {
    format!("[build: {}, module: {}]", env!("VERGEN_BUILD_TIMESTAMP"), 1)
}
