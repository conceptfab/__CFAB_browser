...
a = Analysis(
    ...
    hiddenimports=['PyQt6.QtCore', 'PyQt6.QtGui', 'PyQt6.QtWidgets', 'core.main_window', 'core.json_utils', 'core.amv_tab', 'core.pairing_tab', 'core.tools_tab', 'core.console_tab', 'core.file_utils', 'core.scanner', 'logging', 'json'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
